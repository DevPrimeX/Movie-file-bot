...
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🏷 Title: <a href={url}>{title}</a> / 10</a>\n 𝕋𝕙𝕚𝕤 ℙ𝕠𝕤𝕥 𝕎𝕚𝕝𝕝 𝔹𝕖 𝔻𝕖𝕝𝕖𝕥𝕖𝕕 𝕀𝕟 20 𝕄𝕚𝕟𝕦𝕥𝕖𝕤 𝔽𝕠𝕣 ℂ𝕠𝕡𝕪𝕣𝕚𝕘𝕙𝕥 ℙ𝕣𝕠𝕥𝕖𝕔𝕥𝕚𝕠𝕟 ‼️")
...
time = """300"""
update = """HDFilmz4U"""
group = """Movies_Series_Request_Group"""
howto = """https://t.me/Being_D_evil"""
channel = """HDFilmz4U"""
apishortner = """ced28c0d856ea804fcaf25777ffa7b0642a3d016"""
